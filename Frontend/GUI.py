...
from PyQt5.QtGui import QIcon, QFont, QMovie, QColor, QTextCharFormat, QFont, QPixmap, QTextBlockFormat, QPainter
...
# Wrap GIF label to control layout and prevent stretching
        gif_wrapper = QWidget()
        gif_layout = QHBoxLayout()
        gif_layout.setContentsMargins(0, 0, 0, 0)
        gif_layout.setAlignment(Qt.AlignRight | Qt.AlignBottom)
        gif_layout.addWidget(self.gif_label)
        gif_wrapper.setFixedSize(max_gif_size_W, max_gif_size_H)
        Layout.addWidget(gif_wrapper)

# Add text label below GIF (or wherever you want)
        self.label = QLabel()
...
class CustomTabBar(QWidget):
    ...
    def initUI(self):
        self.setFixedHeight(60)  # Adjust header height
        ...
        title_label.setAlignment(Qt.AlignCenter)  # Optional for center align
    ...
    # Remove Line_Frame if not needed
        Line_Frame = QFrame()
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowFlags(Qt.Window)             # 👈 Fix 1
        self.setWindowTitle("O.R.A.N.G.E.S.")      # 👈 Fix 2
        
        self.initUI()                              # Your UI setup
    ...
    def initUI(self):
        ...
        stacked_widget.setStyleSheet("background-color: black;")
        top_bar = CustomTabBar(self, stacked_widget)
